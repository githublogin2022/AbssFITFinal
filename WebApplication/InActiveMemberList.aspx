<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InActiveMemberList.aspx.cs" Inherits="WebApplication2.InActiveMemberList" %>
        ...
        <div class="header-bottom">
                ...
                <div class="col-md-4 col-sm-1 col-xs-1 mt-30 text-black" style="font-size:10px; text-decoration:underline;">
                    <div class="main-menu f-left text-center">
                                <nav>
                                    <ul>
                                       <li><a style="padding:0px; font-size:16px; color: #FFFFFF; font-family: Stencil;" href="Dashboard.aspx">Dashboard &nbsp;|&nbsp;</a></li>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="copyright">
                                <p style="color: #FFFFFF">
                                    Copyright © 2022 ABSFIT. All Rights Reserved.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
