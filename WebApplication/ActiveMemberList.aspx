<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveMemberList.aspx.cs" Inherits="WebApplication2.ActiveMemberList" %>
    ...
    <header class="header-area home-background">
        ...
        <div class="header-bottom">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-8 col-xs-7 mt-40">
                    <h3  class="text-white text-center" style="font-weight:bolder; font-family: Stencil;">MEMBERSHIP MANAGEMENT SOLUTION</h3>
                        </div>
                
                <div class="col-md-4 col-sm-1 col-xs-1 mt-40 text-white" style="font-size:10px; text-decoration:underline;">
                    <div class="main-menu f-left text-center c1">
                                <nav>
                                    <ul>
                                       <li class="c2"><a style="padding:0px; font-size:16px; font-family: Stencil;" href="Dashboard.aspx">Dashboard &nbsp;| &nbsp;</a> </li>
                                        <li class="c2"><a style="padding:0px; font-size:16px; font-family: Stencil;" href="MemberRegistration.aspx">Add Member &nbsp;| &nbsp;</a></li>
                                       <li class="c2"><a style="padding:0px; font-size:16px; font-family: Stencil;" href="Home.aspx">LOGOUT</a></li>
